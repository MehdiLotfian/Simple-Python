...
(define value-of-for-body (lambda (body iterator glob_env curr_env) (cases statements body
                                                    ...
                                                    (some-statements (sttmnts sttmnt) (let ((res (cadr (value-of-for-body sttmnts iterator glob_env curr_env)))) (cond
...
(define value-of-inversion (lambda (inv glob_env curr_env) (cases inversion inv
                                                             (an-inversion (inv) (bool-val (not (expval->bool (value-of-inversion inv glob_env curr_env)))))
